...
win.rowconfigure((0,1),weight=1)#同步放大縮小
win.columnconfigure((0,1,2),weight=1)

btn1.grid(row=0,column=0,columnspan=1,rowspan=1,sticky='EWNS')#sticky='EWNS'填滿
btn2.grid(row=0,column=1,columnspan=2,rowspan=1,sticky='EWNS')
btn3.grid(row=0,column=3,columnspan=1,rowspan=2,sticky='EWNS')
